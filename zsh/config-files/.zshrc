...
# envirament variables
export NVM_DIR="$([ -z "${XDG_CONFIG_HOME-}" ] && printf %s "${HOME}/.nvm" || printf %s "${XDG_CONFIG_HOME}/nvm")"

# aliases
#
# Prevent user from unexceptionally overwirte the files
alias mv="mv -i"
alias cp="cp -i"
# Open current folder in gnome shell
...
export HBASE_HOME="/home/shang/hbase-2.4.7"
...
export CLASSPATH="$CLASSPATH:/home/shang/hbase-2.4.7/lib/*"
